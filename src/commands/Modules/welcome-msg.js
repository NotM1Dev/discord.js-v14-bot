...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('welcome-msg')
    .setDescription('Manage welcome messages in this server.')
    .setDMPermission(false)
    .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
    .addSubcommand((sub) =>
      sub
        .setName('set')
        .setDescription('Configure a welcome message in a channel.')
    ...
    .addSubcommand((sub) =>
      sub.setName('disable').setDescription('Disable welcome messages from sending.')
    ),
      ...
      case 'set':
        ...
        const embed = new EmbedBuilder()
          ...
          .setFields(
            ...
            { name: 'Message', value: message.toString(), inline: false }
          )
          .setFooter({
            text: guild.name,
      ...
      case 'disable':
        if (!entry) {
          const doesntExistEmbed = new EmbedBuilder()
            .setColor('Red')
            .setDescription('No welcome message configuration exists for this server.')
